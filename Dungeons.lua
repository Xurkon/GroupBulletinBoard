...
-- Ascension Custom Dungeons
GBB.AscensionDungeonLevels = {
  ["VOTI"] = { 60, 80 },
  ["RDOS"] = { 60, 80 },
}

GBB.AscensionDungeonNames  = {
  "VOTI", "RDOS",
}
...
function GBB.GetDungeonSort()
  ...
  -- Add Ascension custom dungeons
  table.insert(dungeonOrder, GBB.AscensionDungeonNames)
  ...
  local ascensionDungeonSize = 0
  for _, _ in pairs(GBB.AscensionDungeonNames) do
    ascensionDungeonSize = ascensionDungeonSize + 1
  end
  ...
  if has_wotlk then
    GBB.WOTLKMAXDUNGEON = vanillaDungeonSize + tbcDungeonSize + #GBB.WotlkDungeonNames
    GBB.TBCMAXDUNGEON = vanillaDungeonSize + tbcDungeonSize
    GBB.WOTLKDUNGEONSTART = GBB.TBCMAXDUNGEON + 1
    GBB.ASCENSIONDUNGEONSTART = GBB.WOTLKMAXDUNGEON + 1
  else
    GBB.TBCMAXDUNGEON = vanillaDungeonSize + tbcDungeonSize
    GBB.ASCENSIONDUNGEONSTART = GBB.TBCMAXDUNGEON + 1
  end
  GBB.ASCENSIONMAXDUNGEON = GBB.ASCENSIONDUNGEONSTART + ascensionDungeonSize - 1
