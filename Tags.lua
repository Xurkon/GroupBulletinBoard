...
GBB.badTagsLoc = langSplit({
  enGB =
  "2s 3s 5s 2v2 2vs2 3v3 3v3s 5v5 5vs5 boost recruit apply social roster raids twitch stream hardcore times team speaking speaker core cores",
  deDE = "fc",
...
GBB.dungeonTagsLoc = {
  enGB = langSplit({
    ...
    ["VOTI"]     = "voti vault inquisition inquisit",
    ["RDOS"]     = "rdos rtdos road otherside other side de'other deother",
